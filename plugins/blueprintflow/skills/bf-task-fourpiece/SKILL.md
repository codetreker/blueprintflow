...
- The milestone passed readiness review or the task is starting.
- The task folder exists under `docs/tasks/<phase>/<milestone>/<task>/`.
- `task.md` exists for the concrete task being executed.
...
- Rewriting `task.md` inside this skill; stop and route scope repair to `bf-task-execute` before baseline docs.
