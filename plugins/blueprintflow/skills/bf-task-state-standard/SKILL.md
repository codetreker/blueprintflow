...
| `docs/tasks/<phase>/phase-plan.md` | Phase staged progress boundary, milestones, exit gates | Task details |
| `docs/tasks/<phase>/<milestone>/milestone.md` | Milestone readiness state, readiness summary, active task index after tasks exist, blockers, closure summary | Full four-piece content |
| `docs/tasks/<phase>/<milestone>/<task>/task.md` | Concrete task scope | Implementation design or progress |
