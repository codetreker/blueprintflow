...
```
.worktrees/al-2a    ← teamlead create, zhanma-c Dev + Architect spec + QA acceptance commit
.worktrees/adm-2    ← teamlead create, zhanma-d Dev + Architect + QA + PM commit
.worktrees/cm-5     ← teamlead create, zhanma-a Dev + ...
.worktrees/bpp-2    ← teamlead create, zhanma-b Dev + ...
```
