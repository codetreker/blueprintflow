...
User approval to continue does not replace harness transitions. If the
immediately previous BF response asked whether to continue execution and the
next user reply is affirmative without adding new scope or objections, continue
means: run the next legal BF command.
