...
- `bf-pr-review-flow`: this skill is what QA's signoff consists of
- `bf-phase-exit-gate`: Line 2+3 walkthrough = regression smoke for UI
- `bf-issue-triage`: out-of-scope findings → new issues

## How to invoke

```
follow skill bf-e2e-verification
```
