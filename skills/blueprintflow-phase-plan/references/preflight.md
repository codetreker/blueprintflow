...
Before using the phase-plan flow, walk this decision graph. If any check returns "yes", skip the heavyweight machinery.
...
| 4 | `docs/blueprint/` missing or only README | No blueprint yet | Redirect to `brainstorm` + `blueprint-write` first |
