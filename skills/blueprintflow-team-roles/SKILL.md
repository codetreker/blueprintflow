...
Top: 4 lines bare metadata → `## Acceptance` → `## Test plan`. Lead-agent can't self-approve; use `gh pr comment <num> --body "LGTM"`. Dual review path: see `blueprintflow-pr-review-flow`.
...
```
follow skill blueprintflow-team-roles
```
