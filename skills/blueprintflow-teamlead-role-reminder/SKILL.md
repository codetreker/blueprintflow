...
- Fast-cron (`blueprintflow-teamlead-fast-cron-checkin`) handles dispatch and merge gates — that's the "what to do" cron
- This skill is the "who am I" cron — they don't overlap
