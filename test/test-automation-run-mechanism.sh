...
assert_eq "$PKG_VERSION" "0.7.18" "package.json version should be bumped for automation runtime change"
assert_eq "$LOCK_VERSION" "0.7.18 0.7.18" "package-lock root versions should be bumped for automation runtime change"
