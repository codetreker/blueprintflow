...
cat > .bf/nodes/code-review/run_1/eval-faker.md <<'EVALEOF'
# Code Review
...
EVALEOF
rm -f .bf/nodes/code-review/run_1/eval-reasoned.md

OUT=$($HARNESS synthesize .bf --node code-review --base project 2>/dev/null)
...
cat > .bf/nodes/code-review/run_1/eval-simple.md <<'EVALEOF'
# Code Review
...
STDERR=$($HARNESS synthesize .bf --node code-review 2>&1 1>/dev/null)
...
STDERR=$($HARNESS synthesize .bf --node code-review --base project 2>&1 1>/dev/null)
...
OUT=$($HARNESS synthesize .bf --node code-review --strict 2>/dev/null)
...
rm -f .bf/nodes/code-review/run_1/eval-*.md
cat > .bf/nodes/code-review/run_1/eval-ok.md <<'EVALEOF'
